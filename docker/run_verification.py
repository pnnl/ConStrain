...
Examples:
  ...
  python run_verification.py /app/workflows/case.json --lib-items /app/custom_lib.json
    ...
    parser.add_argument("case_file", help="Path to the verification case JSON file")
    ...
    parser.add_argument("--data", help="Path to preprocessed data CSV file (optional)")
        ...
        if not os.path.exists(args.data):
            ...
            try:
                ...
                data_processing = DataProcessing(
                    data_path=args.data, data_source="EnergyPlus"
                )
