...
def main():
    ...
    if is_default_workflow:
        constrain_root = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'constrain')
        if os.path.exists(constrain_root):
            ...
            workflow_path = os.path.relpath(os.path.abspath(os.path.join('/app', workflow_path)), constrain_root)
