...
class Verification:
    ...
    def configure(
        ...
        Args:
            ...
            lib_classes_folder (str, optional): User provided verification item python classes folder.
    ...
    def run_single_verification(self, case: dict = None) -> None:
        ...
        results = run_libcase(
            item_dict=items[0],
            user_lib_folder=self.lib_classes_py_file,
