...
def _base_context(request: Request) -> Dict[str, Any]:
    return {
        ...
        "verification_inputs": {
            "case_file_path": "/user_io/examples/input/verification_cases/G36_library_verification_cases.json",
            "output_dir": "/user_io/examples/output/manual-run",
            "data_file_path": "/user_io/examples/input/data/G36_Modelica_Jan.csv",
            "library_json_path": "/user_io/examples/input/schema/library.json",
            "plot_option": "all-compact",
            "fig_width": "6.4",
            "fig_height": "4.8",
            "tolerances_file_path": "/app/tolerances.json",
            "log_level": "INFO",
