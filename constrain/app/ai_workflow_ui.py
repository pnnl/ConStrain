...
def _base_context(request: Request) -> Dict[str, Any]:
    return {
        ...
        "verification_inputs": {
            "case_file_path": "/user_io/input/verification_cases/case.json",
            "output_dir": "/user_io/output/run-1",
            "data_file_path": "/user_io/input/data/data.csv",
            "library_json_path": "/user_io/input/schema/library.json",
