...
class TestBrickCompliance(unittest.TestCase):
    ...
    def test_query_verification_case_datapoints(self):
        ...
        self.assertEqual(
            zone1_info["T_cool_set"]["subject"],
            "zone_1",
        )
        self.assertEqual(
            zone1_info["T_cool_set"]["variable"],
            "Zone Thermostat Cooling Setpoint Temperature",
        )

        self.assertEqual(
            zone1_info["T_heat_set"]["subject"],
            "zone_1",
        )
        self.assertEqual(
            zone1_info["T_heat_set"]["variable"],
        ...
        self.assertEqual(
            zone2_info["T_cool_set"]["subject"],
            "zone_2",
        )
        self.assertEqual(
            zone2_info["T_cool_set"]["variable"],
            "Zone Thermostat Cooling Setpoint Temperature",
        )

        self.assertEqual(
            zone2_info["T_heat_set"]["subject"],
            "zone_2",
        )
        self.assertEqual(
            zone2_info["T_heat_set"]["variable"],
            "Zone Thermostat Heating Setpoint Temperature",
        )
